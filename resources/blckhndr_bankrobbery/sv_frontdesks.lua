...
RegisterServerEvent('blckhndr_bankrobbery:desks:doorUnlock')
AddEventHandler('blckhndr_bankrobbery:desks:doorUnlock', function(bank)
	desks[bank]['door'].locked = false
	TriggerClientEvent('blckhndr_bankrobbery:desks:receive', -1, desks)
end)

RegisterServerEvent('blckhndr_bankrobbery:desks:request')
AddEventHandler('blckhndr_bankrobbery:desks:request', function()
	TriggerClientEvent('blckhndr_bankrobbery:desks:receive', source, desks)
end)

RegisterServerEvent('blckhndr_bankrobbery:desks:startHack')
AddEventHandler('blckhndr_bankrobbery:desks:startHack', function(bank, board)
...
RegisterServerEvent('blckhndr_bankrobbery:desks:endHack')
AddEventHandler('blckhndr_bankrobbery:desks:endHack', function(bank, board, state)
	local computer = desks[bank]['keyboards'][board]
	if state then
		-- hacking was successful
		computer['robbed'] = 'hacked'
		TriggerClientEvent('blckhndr_bank:change:bankAdd', source, computer['payout'])
