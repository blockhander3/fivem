...
local clothing_shops = {
    {name="Sheriff Office", id=60, x=1849.76, y=3695.49, z=34.16}, --Sandy Station Station
    ...
    {name="Sheriff Office", id=60, x=-456.84579467773, y=6014.3266601562, z=31.71654510498}, --Paleto Bay Station
}
incircle = false
            ...
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("Nyomj ~INPUT_CONTEXT~ gombot, hogy megváltoztasd a kinézeted. (~g~$100~w~)")
                    end
                    incircle = true
                    if IsControlJustReleased(1, 51) then -- INPUT_CELLPHONE_DOWN
                        ...
                        OpenClothes()
                        TriggerEvent('blckhndr_bank:change:walletMinus', 100)
                    end
