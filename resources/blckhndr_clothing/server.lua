...
RegisterServerEvent('blckhndr_clothing:requestDefault')
AddEventHandler('blckhndr_clothing:requestDefault', function()
	
	TriggerClientEvent('blckhndr_clothing:change', source, data)
end)

RegisterServerEvent('blckhndr_clothing:save')
AddEventHandler('blckhndr_clothing:save', function(data)
