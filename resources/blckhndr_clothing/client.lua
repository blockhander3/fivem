...
RegisterNetEvent('blckhndr_clothing:menu')
AddEventHandler('blckhndr_clothing:menu', function()
...
AddEventHandler("clothes:changemodel", function(skin)
	...
	TriggerEvent('blckhndr_criminalmisc:weapons:equip')
...
AddEventHandler("clothes:spawn", function(data)
	...
	if data and type(data) == "table" and data.model then
		...
		print('blckhndr_clothing: no clothing data????')
	end
	TriggerEvent('blckhndr_criminalmisc:weapons:equip')
