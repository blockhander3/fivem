window.APP = {
  ...
  mounted() {
    post('http://blckhndr_newchat/loaded', JSON.stringify({}));
  ...
  methods: {
    ...
    send(e) {
      if(this.message !== '') {
        post('http://blckhndr_newchat/chatResult', JSON.stringify({
    ...
    hideInput(canceled = false) {
      if (canceled) {
        post('http://blckhndr_newchat/chatResult', JSON.stringify({ canceled }));
      }
      this.message = '';
