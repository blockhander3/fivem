...
function Util.PrependTable(t, v)
	if not t then print('blckhndr_main (cl_utils.lua) [Util.PrependTable] - You need to provide a table in argument position 1') return end
	if not v then print('blckhndr_main (cl_utils.lua) [Util.PrependTable] - You need to provide a value in argument position 2') return end
	if #t > 0 and not t[1] then print('blckhndr_main (cl_utils.lua) [Util.PrependTable] - Table provided is not using numbers for keys.') return end
