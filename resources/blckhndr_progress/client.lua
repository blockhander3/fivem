...
function blckhndr_ProgressBar(r,g,b,title,length)
	if not isDisplayed then
		isDisplayed = true
		displayStart = exports["blckhndr_main"]:blckhndr_GetTime()
		Citizen.CreateThread(function()
			while isDisplayed do
				...
				if maff <= exports["blckhndr_main"]:blckhndr_GetTime() then
					...
					local remaining = maff - exports["blckhndr_main"]:blckhndr_GetTime()
...
--blckhndr_ProgressBar(255,0,0,'a',300)
