...
function getThirst()
	return exports["blckhndr_needs"]:blckhndr_thirst()
end
function getHunger()
	return exports["blckhndr_needs"]:blckhndr_hunger()
end
function getStress()
	return exports["blckhndr_needs"]:blckhndr_stress()
end
...
RegisterNetEvent('blckhndr_inventory:useArmor')
AddEventHandler('blckhndr_inventory:useArmor', function()
	local playerPed = PlayerPedId()
	--print(armortype)
	if GetPedArmour(playerPed) < 100 then
		exports["blckhndr_progress"]:blckhndr_ProgressBar(58, 133, 255,'Putting on armor', 10)
		Citizen.Wait(10000)
		TriggerEvent('blckhndr_inventory:item:take', 'armor', 1)
