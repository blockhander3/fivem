...
RegisterNetEvent('blckhndr_characterdetails:recievetattoos')
AddEventHandler('blckhndr_characterdetails:recievetattoos', function(Data)
...
function PurchaseTattoo()
    ...
    TriggerEvent('blckhndr_main:saveCharacter')
end
