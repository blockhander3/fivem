...
AddEventHandler('blckhndr_notify:displayNotification', function(msg, place, time, type)
  TriggerEvent('pNotify:SendNotification', {text = msg, layout = place, timeout = time, type = type})
end)
