...
-- Mission Row Cell 2
  ...
  --{x = 1856.9885253906, y = 3689.5842285156, z = 3689.5842285156},
  -- OLD ONES KEEP INCASE I REVERT LOLZ
  [70] = { ["objName"] = -2023754432, ["x"]= 1856.9885253906, ["y"]= 3689.5842285156, ["z"]= 3689.5842285156,["locked"]= true,["txtX"]= 1856.9885253906,["txtY"]=3689.5842285156,["txtZ"]=3689.5842285156},
  -- PD lower first left
...
RegisterServerEvent('blckhndr_doormanager:unlockDoor')
AddEventHandler('blckhndr_doormanager:unlockDoor', function(doorType, doorID)
  if doorType == 'police' then
    local door = policeDoors[doorID]
    door["locked"] = false
    TriggerClientEvent('blckhndr_doormanager:doorUnlocked', -1, doorType, doorID)
  end
end)

RegisterServerEvent('blckhndr_doormanager:lockDoor')
AddEventHandler('blckhndr_doormanager:lockDoor', function(doorType, doorID)
  if doorType == 'police' then
    local door = policeDoors[doorID]
    door["locked"] = true
    TriggerClientEvent('blckhndr_doormanager:doorLocked', -1, doorType, doorID)
  end
end)

RegisterServerEvent('blckhndr_doormanager:requestDoors')
AddEventHandler('blckhndr_doormanager:requestDoors', function()
  TriggerClientEvent('blckhndr_doormanager:sendDoors', source, policeDoors, propertyDoors)
end)
