...
function OpenCreator(changingBoat)
	...
	boughtboat = false
	local ped = LocalPed()
	local pos = {1329.5306396484, 4252.1303710938, 29.809881210327, 275.9475402832}
...
function CloseCreator()
	Citizen.CreateThread(function()
		...
		if not boughtboat then
			local pos = {1336.1643066406, 4270.0668945312, 31.503141403198, 0.0}
			...
			local pos = {1336.1643066406, 4270.0668945312, 31.503141403198, 0.0}--currentlocation.pos.outside
			SetEntityCoords(ped,pos[1],pos[2],pos[3])
			FreezeEntityPosition(ped,false)
			SetEntityVisible(ped,true)
			...
			TriggerServerEvent('blckhndr_boatshop:floor:ChangeBoat', boatIamChanging, ibought)
		end
...
function ButtonSelected(button)
	...
	elseif this == "boats" then
		--if tonumber(exports.blckhndr_main:blckhndr_GetWallet()) >= button.costs then
