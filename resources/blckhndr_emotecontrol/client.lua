...
RegisterNetEvent('blckhndr_emotecontrol:play')
AddEventHandler('blckhndr_emotecontrol:play', function(type, dict, anim)
...
RegisterKeyMapping('ceclear', '[ANIMÁCIÓ] Animáció megszakítása','keyboard', '')
RegisterCommand('ceclear', function()
	stopAnim()
end, false)
function stopAnim()
local lPed = GetPlayerPed(-1)
...
-----------------------
RegisterNetEvent('blckhndr_emotecontrol:phone:call1')
AddEventHandler('blckhndr_emotecontrol:phone:call1', function()
...
RegisterNetEvent('blckhndr_emotecontrol:dice:roll')
AddEventHandler('blckhndr_emotecontrol:dice:roll', function()
    if not IsPedInAnyVehicle(GetPlayerPed(-1)) then
...
RegisterNetEvent('blckhndr_emotecontrol:police:ticket')
AddEventHandler('blckhndr_emotecontrol:police:ticket', function()
...
RegisterNetEvent('blckhndr_emotecontrol:police:tablet')
AddEventHandler('blckhndr_emotecontrol:police:tablet', function(status)
